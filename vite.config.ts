      ...
      '/api/instagram': {
        ...
        configure: (proxy, options) => {
          proxy.on('proxyReq', (proxyReq, req, res) => {
            proxyReq.setHeader('x-rapidapi-key', '4dd843cf7emsh2f863ef92f39024p13fe73jsn2bd67e697dcc');
            proxyReq.setHeader('x-rapidapi-host', 'instagram-looter2.p.rapidapi.com');
          });
        },
      },
